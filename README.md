...
* [`asremlPlus 4.4.32`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.2.26`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.
...
Windows binary R 4.4: [asremlPlus_4.4.32.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.32.zip);   Windows binary R 4.3: [asremlPlus_4.4.32.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/asremlPlus_4.4.32.zip); Package source: [asremlPlus_4.4.32.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.32.tar.gz).
...
Windows binary R 4.4: [dae_3.2.26.zip](http://briencj.github.io/drat/bin/windows/contrib/4.6/dae_3.2.26.zip);  Windows binary R 4.3: [dae_3.2.26.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/dae_3.2.26.zip);  Package source: [dae_3.2.26.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.2.26.tar.gz).
