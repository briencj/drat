...
* [`asremlPlus 4.4.52`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.
...
Windows binary R 4.5: [asremlPlus_4.4.52.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/asremlPlus_4.4.52.zip);   Windows binary R 4.4: [asremlPlus_4.4.52.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.52.zip); Package source: [asremlPlus_4.4.52.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.52.tar.gz).
