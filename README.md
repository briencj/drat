...
* [`asremlPlus 4.4.31`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.
...
Windows binary R 4.3: [asremlPlus_4.4.31.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/asremlPlus_4.4.31.zip); Windows binary R 4.2: [asremlPlus_4.4.31.zip](http://briencj.github.io/drat/bin/windows/contrib/4.2/asremlPlus_4.4.31.zip);   Package source: [asremlPlus_4.4.31.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.31.tar.gz).
