...
* [`dae 3.1-38`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.
...
Windows binary R 4.0: [dae_3.1-38.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/dae_3.1-38.zip);  Windows binary R 3.6: [dae_3.1-38.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/dae_3.1-38.zip);  Package source: [dae_3.1-38.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.1-38.tar.gz).
