...
* [`asremlPlus 4.4.46`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.2.30`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.

* [`growthPheno 3.1.10`](#gpheno) - functional analysis of phenotypic growth data to smooth and extract traits.
...
### `asremlPlus` {#aplus}
*(last updated 17th Fenruary 2025)*
...
Windows binary R 4.4: [asremlPlus_4.4.46.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.46.zip);   Windows binary R 4.3: [asremlPlus_4.4.46.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/asremlPlus_4.4.46.zip); Package source: [asremlPlus_4.4.46.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.46.tar.gz).

The package is also available from CRAN at <https://cran.r-project.org/package=asremlPlus> and from the Github repo at <https://github.com/briencj/asremlPlus>. However, the CRAN version, currently 4.4.46, is not updated as frequently as the version that is here and on [GitHub](https://github.com/briencj/asremlPlus). Older versions of the package and versions for older R versions are available from <https://github.com/briencj/drat/tree/gh-pages>.
...
Windows binary R 4.4: [dae_3.2.30.zip](http://briencj.github.io/drat/bin/windows/contrib/4.6/dae_3.2.30.zip);  Windows binary R 4.3: [dae_3.2.30.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/dae_3.2.30.zip);  Package source: [dae_3.2.30.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.2.30.tar.gz).
...
Windows binary R 4.4: [growthPheno_3.1.10.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/growthPheno_3.1.10.zip);  Windows binary R 4.3: [growthPheno_3.1.10.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/growthPheno_3.1.10.zip); Package source: [growthPheno_3.1.10.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_3.1.10.tar.gz).

The package is also available from CRAN: <https://cran.r-project.org/package=growthPheno> and from the Github repo at <https://github.com/briencj/growthPheno>. However, the CRAN version, currently 3.1.10, is not updated as frequently as the version here. Older versions of the package and versions for older R versions are available from <https://github.com/briencj/drat/tree/gh-pages>.
