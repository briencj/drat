...
* [`growthPheno 3.1.17`](#gpheno) - functional analysis of phenotypic growth data to smooth and extract traits.
...
Windows binary R 4.5: [growthPheno_3.1.17.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/growthPheno_3.1.17.zip);  Windows binary R 4.4: [growthPheno_3.1.17.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/growthPheno_3.1.17.zip); Package source: [growthPheno_3.1.17.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_3.1.17.tar.gz).
