...
* [`dae 3.2.30`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.
...
Windows binary R 4.5: [dae_3.2.30.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/dae_3.2.30.zip);  Windows binary R 4.4: [dae_3.2.30.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/dae_3.2.30.zip);  Package source: [dae_3.2.30.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.2.30.tar.gz).
