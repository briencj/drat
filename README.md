...
* [`growthPheno 1.0-27`](#gpheno) - plotting, smoothing and growth trait extraction for longitudinal data.
...
Windows binary R 4.0: [growthPheno_1.0-27.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/growthPheno_1.0-27.zip); Windows binary R 3.6: [growthPheno_1.0-27.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/growthPheno_1.0-27.zip);   Package source: [growthPheno_1.0-27.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_1.0-27.tar.gz).
