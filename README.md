...
* [`asremlPlus 4.4.24`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.
...
Windows binary R 4.3: [asremlPlus_4.4.24.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/asremlPlus_4.4.24.zip); Windows binary R 4.2: [asremlPlus_4.4.24.zip](http://briencj.github.io/drat/bin/windows/contrib/4.2/asremlPlus_4.4.24.zip);   Package source: [asremlPlus_4.4.24.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.24.tar.gz).
