...
* [`asremlPlus 4.2-14`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.
...
Windows binary R 3.6: [asremlPlus_4.2-14.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/asremlPlus_4.2-14.zip);  Windows binary R 3.5: [asremlPlus_4.2-14.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/asremlPlus_4.2-14.zip);  Package source: [asremlPlus_4.2-14.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.2-14.tar.gz).
