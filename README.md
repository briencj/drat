...
* [`asremlPlus 4.2-20`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.1-26`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.

* [`growthPheno 1.0-25`](#gpheno) - plotting, smoothing and growth trait extraction for longitudinal data.
...
Windows binary R 4.0: [asremlPlus_4.2-20.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/asremlPlus_4.2-20.zip); Windows binary R 3.6: [asremlPlus_4.2-20.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/asremlPlus_4.2-20.zip);   Package source: [asremlPlus_4.2-20.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.2-20.tar.gz).
...
Windows binary R 4.0: [dae_3.1-26.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/dae_3.1-26.zip);  Windows binary R 3.6: [dae_3.1-26.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/dae_3.1-26.zip);  Package source: [dae_3.1-26.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.1-26.tar.gz).
...
Windows binary R 4.0: [growthPheno_1.0-25.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/growthPheno_1.0-25.zip); Windows binary R 3.6: [growthPheno_1.0-25.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/growthPheno_1.0-25.zip);   Package source: [growthPheno_1.0-25.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_1.0-25.tar.gz).
