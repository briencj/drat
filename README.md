...
* [`asremlPlus 4.4.49`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.2.30`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.

* [`growthPheno 3.1.12`](#gpheno) - functional analysis of phenotypic growth data to smooth and extract traits.
...
Windows binary R 4.5: [asremlPlus_4.4.49.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/asremlPlus_4.4.49.zip);   Windows binary R 4.4: [asremlPlus_4.4.49.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.49.zip); Package source: [asremlPlus_4.4.49.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.49.tar.gz).

The package is also available from CRAN at <https://cran.r-project.org/package=asremlPlus> and from the Github repo at <https://github.com/briencj/asremlPlus>. However, the CRAN version, currently 4.4.48, is not updated as frequently as the version that is here and on [GitHub](https://github.com/briencj/asremlPlus). Older versions of the package and versions for older R versions are available from <https://github.com/briencj/drat/tree/gh-pages>.
...
Windows binary R 4.5: [growthPheno_3.1.12.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/growthPheno_3.1.12.zip);  Windows binary R 4.4: [growthPheno_3.1.12.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/growthPheno_3.1.12.zip); Package source: [growthPheno_3.1.12.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_3.1.12.tar.gz).
