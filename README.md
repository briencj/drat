...
* [`growthPheno 3.1.11`](#gpheno) - functional analysis of phenotypic growth data to smooth and extract traits.
...
Windows binary R 4.4: [growthPheno_3.1.11.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/growthPheno_3.1.11.zip);  Windows binary R 4.3: [growthPheno_3.1.11.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/growthPheno_3.1.11.zip); Package source: [growthPheno_3.1.11.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_3.1.11.tar.gz).
