...
Windows binary: [asremlPlus_4.1-05.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/asremlPlus_4.1-05.zip);  Package source: [asremlPlus_4.1-05.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.1-05.tar.gz).
...
Windows binary: [dae_3.0-19.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/dae_3.0-19.zip);  Package source: [dae_3.0-19.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.0-19.tar.gz).
