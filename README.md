...
* [`asremlPlus 4.4.33`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.2.27`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.
...
Windows binary R 4.4: [asremlPlus_4.4.33.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.33.zip);   Windows binary R 4.3: [asremlPlus_4.4.33.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/asremlPlus_4.4.33.zip); Package source: [asremlPlus_4.4.33.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.33.tar.gz).

The package is also available from CRAN at <https://cran.r-project.org/package=asremlPlus> and from the Github repo at <https://github.com/briencj/asremlPlus>. However, the CRAN version, currently 4.4.32, is not updated as frequently as the version that is here and on [GitHub](https://github.com/briencj/asremlPlus). Older versions of the package and versions for older R versions are available from <https://github.com/briencj/drat/tree/gh-pages>.
...
Windows binary R 4.4: [dae_3.2.27.zip](http://briencj.github.io/drat/bin/windows/contrib/4.6/dae_3.2.27.zip);  Windows binary R 4.3: [dae_3.2.27.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/dae_3.2.27.zip);  Package source: [dae_3.2.27.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.2.27.tar.gz).

The package is also available from CRAN at <https://cran.r-project.org/package=dae> and from the Github repo at <https://github.com/briencj/dae>. However, the CRAN version, currently 3.2.25, is not updated as frequently as the version that is here and on [GitHub](https://github.com/briencj/dae). Older versions of the package and versions for older R versions are available from <https://github.com/briencj/drat/tree/gh-pages>.  
...
Windows binary R 4.4: [growthPheno_2.1.24.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/growthPheno_2.1.24.zip);  Windows binary R 4.3: [growthPheno_2.1.24.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/growthPheno_2.1.24.zip); Package source: [growthPheno_2.1.24.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_2.1.24.tar.gz).
