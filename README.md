...
* [`asremlPlus 4.2-28`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.1-37`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.
...
Windows binary R 4.0: [asremlPlus_4.2-28.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/asremlPlus_4.2-28.zip); Windows binary R 3.6: [asremlPlus_4.2-28.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/asremlPlus_4.2-28.zip);   Package source: [asremlPlus_4.2-28.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.2-28.tar.gz).

The package is also available from CRAN at <https://cran.r-project.org/package=asremlPlus> and from the Github repo at <https://github.com/briencj/asremlPlus>. However, the CRAN version, currently 4.2-26, is not updated as frequently as the version here or on GitHub. 
...
Windows binary R 4.0: [dae_3.1-37.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/dae_3.1-37.zip);  Windows binary R 3.6: [dae_3.1-37.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/dae_3.1-37.zip);  Package source: [dae_3.1-37.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.1-37.tar.gz).

The package is also available from CRAN at <https://cran.r-project.org/package=dae> and from the Github repo at <https://github.com/briencj/dae>. However, the CRAN version, currently 3.1-32, is not updated as frequently as the version here or on GitHub.  
