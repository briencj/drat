...
* [`asremlPlus 4.4.37`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.
...
Windows binary R 4.4: [asremlPlus_4.4.37.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.37.zip);   Windows binary R 4.3: [asremlPlus_4.4.37.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/asremlPlus_4.4.37.zip); Package source: [asremlPlus_4.4.37.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.37.tar.gz).
...
Windows binary R 4.4: [dae_3.2.29.zip](http://briencj.github.io/drat/bin/windows/contrib/4.6/dae_3.2.29.zip);  Windows binary R 4.3: [dae_3.2.29.zip](http://briencj.github.io/drat/bin/windows/contrib/4.3/dae_3.2.29.zip);  Package source: [dae_3.2.29.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.2.29.tar.gz).
