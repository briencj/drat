...
* [`asremlPlus 4.2-22`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.1-29`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.
...
Windows binary R 4.0: [asremlPlus_4.2-22.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/asremlPlus_4.2-22.zip); Windows binary R 3.6: [asremlPlus_4.2-22.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/asremlPlus_4.2-22.zip);   Package source: [asremlPlus_4.2-22.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.2-22.tar.gz).
...
Windows binary R 4.0: [dae_3.1-29.zip](http://briencj.github.io/drat/bin/windows/contrib/4.0/dae_3.1-29.zip);  Windows binary R 3.6: [dae_3.1-29.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/dae_3.1-29.zip);  Package source: [dae_3.1-29.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.1-29.tar.gz).
