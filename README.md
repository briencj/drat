...
Windows binary R 3.6: [asremlPlus_4.1-29.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/asremlPlus_4.1-29.zip);  Windows binary R 3.5: [asremlPlus_4.1-29.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/asremlPlus_4.1-29.zip);  Package source: [asremlPlus_4.1-29.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.1-29.tar.gz).
...
Windows binary R 3.6: [dae_3.0-32.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/dae_3.0-32.zip);  Windows binary R 3.5: [dae_3.0-32.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/dae_3.0-32.zip);  Package source: [dae_3.0-32.tar.gz](http://briencj.github.io/drat/src/contrib/dae_3.0-32.tar.gz).
...
Windows binary R 3.6: [growthPheno_1.0-16.zip](http://briencj.github.io/drat/bin/windows/contrib/3.6/growthPheno_1.0-16.zip);  Windows binary R 3.5: [growthPheno_1.0-16.zip](http://briencj.github.io/drat/bin/windows/contrib/3.5/growthPheno_1.0-16.zip);  Package source: [growthPheno_1.0-16.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_1.0-16.tar.gz).
