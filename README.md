...
* [`asremlPlus 4.4.54`](#aplus) - augments `ASReml-R` in fitting mixed models and packages generally in exploring prediction differences.

* [`dae 3.2.32`](#dae) - facilitates the use of R for the design and analysis of variance of experiments.

* [`growthPheno 3.1.16`](#gpheno) - functional analysis of phenotypic growth data to smooth and extract traits.
...
Windows binary R 4.5: [asremlPlus_4.4.54.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/asremlPlus_4.4.54.zip);   Windows binary R 4.4: [asremlPlus_4.4.54.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/asremlPlus_4.4.54.zip); Package source: [asremlPlus_4.4.54.tar.gz](http://briencj.github.io/drat/src/contrib/asremlPlus_4.4.54.tar.gz).
...
Windows binary R 4.5: [growthPheno_3.1.16.zip](http://briencj.github.io/drat/bin/windows/contrib/4.5/growthPheno_3.1.16.zip);  Windows binary R 4.4: [growthPheno_3.1.16.zip](http://briencj.github.io/drat/bin/windows/contrib/4.4/growthPheno_3.1.16.zip); Package source: [growthPheno_3.1.16.tar.gz](http://briencj.github.io/drat/src/contrib/growthPheno_3.1.16.tar.gz).
